...
AnimationSprite::AnimationSprite(GLfloat numFrames, GLfloat frameTime, std::shared_ptr<Models> model, std::shared_ptr<Shaders> shader,
	std::shared_ptr<Texture> texture): Sprite2D::Sprite2D(model, shader, texture)
{
